/**
 * Created by Luforn on 2016-01-28.
 */
...
mui.ready(function(){
    ...
    document.getElementById('split_label').addEventListener('tap', function(){
        var labelid = document.getElementById('label_detail_pullrefresh').getAttribute('labelid');
        window.location.replace('/aaswechat/mes/labelsplit/'+labelid);
    });


    document.getElementById('print_label').addEventListener('tap', function(){
