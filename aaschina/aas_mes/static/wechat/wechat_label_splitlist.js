...
mui.ready(function(){
    ...
    document.getElementById('action_print').addEventListener('tap', function(){
        ...
        var label_id = parseInt(document.getElementById('label_splitlist_pullrefresh').getAttribute('labelid'));
        var printparams = {'printerid': printerid, 'labelid': label_id};
        var access_id = Math.floor(Math.random() * 1000 * 1000 * 1000);
        mui.ajax('/aaswechat/mes/printsplitlabels', {
            ...
            success: function (data) {
                ...
                var printurl = 'http://'+dresult.serverurl;
