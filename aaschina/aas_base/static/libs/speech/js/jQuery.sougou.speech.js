/**
 * Created by luforn on 2018-3-30.
 */
...
(function($) {
	$.fn.speech = function(options) {
		var defaults = {
			...
			"sHeight": 13, //链接按钮的高度
			"https": true, //启用https
			"bg": "./images/speech.png", //链接按钮的背景图片
		...
		return this.each(function() {
			...
			var src = http + '://fanyi.sogou.com/reventondc/microsoftGetSpeakFile?from=translateweb&spokenDialect=zh-CHS&text=' + content;
			if (options.speech) {
				//点击链接播报
